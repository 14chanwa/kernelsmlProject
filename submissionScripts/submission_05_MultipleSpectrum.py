...
print("Training accuracy:", accuracy, "expected~", 0.95) # expected perf 0.7475
...
tmp = Ytr1 == np.sign(f)
accuracy = np.sum(tmp) / np.size(tmp)
print("Training accuracy:", accuracy, "expected~", 0.995) # expected perf 0.8795
...
tmp = Ytr2 == np.sign(f)
accuracy = np.sum(tmp) / np.size(tmp)
print("Training accuracy:", accuracy, "expected~", 0.98) # expected perf 0.643. Bad!!
